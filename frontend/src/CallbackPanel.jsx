...
import {Alert, Button, Dropdown, Empty, Input, Modal, Popover, Select, Space, Table, Tag, Tooltip} from "antd";
import {
  ApiOutlined,
  ApartmentOutlined,
  ArrowRightOutlined,
...
function CallbackDetailModal({row, open, onClose, onAfterClose, t}) {
  if (!row) return null;
