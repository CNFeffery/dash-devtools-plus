...
| --- | --- | --- |
| Callback relationships | Callback topology, sources, roles, and lifecycle performance with grouped server/network timing | [Open](features/callbacks.md) |
| Server resource monitor | Live CPU, memory, disk, and runtime information with filterable trends | [Open](features/server-metrics.md) |
